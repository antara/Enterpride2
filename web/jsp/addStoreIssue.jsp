                ...
                <option value ="${itemidloop.id}"><c:out value="${itemidloop.itemCode}"/></option>
					...
					<%--               <c:set var="newIndex" value="${loop.index + 1}" scope="page"/>--%>
					       ...
					       <td style="border-top:1px solid #000000;border-right:1px solid #000000;">
					         ...
					         <div align="left" style="margin-left:4px;">
					         <div align="right">
					            <s:text  name="requisitiondetailarray[${loop.index}].requiredQty" id="reqQty[${loop.index}]" readonly="readonly" value="${requisitiondetailarray.requiredQty}" style="text-align:right;margin-right:2px;width:100px; "/>
					         </div></div></td>
                             <td style="border-top:1px solid #000000;border-right:1px solid #000000;">
					         <div align="left" style="margin-left:4px;">
					         <div align="right">
