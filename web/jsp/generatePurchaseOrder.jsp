...
Purchase Order > Generate
 ...
 <table width="50%" border="0"><tr><td width="43%" align="left" valign="top">
...
<s:select id="vendorName" name="id" class="dropdown">
              ...
              <td width="3%" align="left" valign="top">&nbsp;<s:hidden name="purchaseOrder.deleted" value="1"/></td>
<td width="33%" align="left" valign="top" > <s:submit name="getToGenaratePurchaseOrder"  value="Get"/></td>
						</tr></table>
           </s:form>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td width="15%">&nbsp;
                <s:hidden name="purchaseOrder.deleted" value="1"/>
        </td>                       <s:hidden name="test" value="gettestvalue"/>
        <td width="48%">&nbsp;
                <s:hidden id="purchaseOrderid" name="purchaseOrder.id" value="${purchaseOrder.id}" class="textbox"></s:hidden>
        ...
        <td width="48%">&nbsp;    <s:hidden name="purchaseOrder.status" value="open"/>
                ...
                <s:hidden id="id" name="id" value="${purchaseOrder.id}" class="textbox"></s:hidden>
        </td>
     <tr>
        <td width="16%" align="left" valign="top">
  ...
  <%-- <tr>
       <td width="16%" align="left" valign="top">
         <div align="left" style="margin-left: 2px;" class="labels">
           <div align="right">Name of Supplier</div>
         </div></td>
	<td width="21%" align="left" valign="top"><div align="left">
        ...
        <td width="48%">&nbsp;<s:hidden id="purchaseOrderid" name="purchaseOrder.id" value="${purchaseOrder.id}" class="textbox"></s:hidden></td>
       <s:hidden id="pid" name="id" class="textbox"></s:hidden>
