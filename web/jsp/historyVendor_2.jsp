 ...
 $('#myDiv2').toggle();
     ...
     $('input:radio[name="search"]').change(function(){
		...
		//	source: availableTags
         ...
         else if($(this).val() == 'byVendorName'){
               $.get("/Vendor.action?autovendor",function(result) {
        var availableTags=eval(result);
        $("input#autocomplete").autocomplete({
            source: availableTags
        });
...
<tr><td>
    <table width="66%" border="0" >
      <tr>
        ...
        <td width="6%" align="right" valign="top"><s:radio  value="byVendorName"  id="radio1"  name="search"></s:radio></td>
      ...
      <tr>
        ...
        <td align="center" colspan="4">
                 <c:if test="${actionBean.vendorlst!=null}">
                   <c:choose>
                        <c:when test="${actionBean.search eq 'name'}">
                          <div id="myDiv"  align="left" style="margin-left: 2px;" class="labels">Enter Name<span style=" color:#FF0000"> * </span><s:text id="autocomplete" name="vendor.name"/><s:submit name="history" value="Get"></s:submit></div>
                        </c:when>
                     <c:otherwise>
                 ...
                 <s:hidden name="vendor.id" id="vendorid" value="${actionBean.vendor.id}"></s:hidden>
                <div id="myDiv" style="display:none;" align="left" style="margin-left: 2px;" class="labels">Enter Name<span style=" color:#FF0000"> * </span><s:text id="autocomplete" name="vendor.name"/><s:submit name="history" value="Get"></s:submit></div>
