...
<![endif]-->
    ...
    <![endif]-->
		...
		<ul>
            ...
            <li><s:link beanclass="com.erp.action.GrnActionBean" event="verify">Verify GRN</s:link></li>
            <li><s:link beanclass="com.erp.action.GrnActionBean" event="forAccountant">Verified GRNs</s:link></li>
